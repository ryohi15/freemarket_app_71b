...
categories=[
           {level1:"レディース",level1_children:[
            {level2:"トップス",level2_children:["Tシャツ/カットソー(半袖/袖なし)","Tシャツ/カットソー(七分/長袖)","シャツ/ブラウス(半袖/袖なし)","シャツ/ブラウス(七分/長袖)","ポロシャツ","キャミソール","タンクトップ","ホルターネック","ニット/セーター","チュニック","カーディガン/ポロ","アンサンブル","ベスト/ジレ","パーカー"]},
            {level2:"ジャケット/アウター",level2_children:["テーラードジャケット","ノーカラージャケット","Gジャン/デニムジャケット","レザージャケット","ダウンジャケット","ライダースジャケット","ミリタリージャケット","ダウンベスト","ジャンバー/ブルゾン","ポンチョ","ロングコート","トレンチコート","ダッフルコート","ピーコート"]},
            ...
            {level2:"帽子",level2_children:["ニットキャップ/ピーニー","ハット","ハンチング/ベレー帽","キャップ","キャスケット","麦わら帽子","その他"]},
            {level2:"バッグ",level2_children:["ハンドバッグ","トートバッグ","エコバッグ","リュック/バックパック","ボストンバッグ","スポーツバッグ","ショルダーバッグ","クラッチバッグ","ポーチ/バニティ","ボディバッグ/ウェストバッグ","マザーズバッグ","メッセンジャーバッグ","ビジネスバッグ","旅行用バッグ/キャリーバッグ"]},
            ...
            {level2:"小物",level2_children:["長財布","折り財布","コインケース/小物入れ","キーケース","キーホルダー","手袋/アームカバー","ハンカチ","ベルト","マフラー/ショール","ストール/スヌード","バンダナ/スカーフ","ネックウォーマー","サスペンダー"]},
            {level2:"時計",level2_children:["腕時計(デジタル)","腕時計(アナログ)","ラバーベルト","レザーベルト","金属ベルト","その他"]},
           ...
           {level1:"メンズ",level1_children:[
            ...
            {level2:"レッグウェア",level2_children:["ソックス","スパッツ/レギンス","レッグウォーマー","その他"]},
           ...
           {level1:"おもちゃ・ホビー・グッズ",level1_children:[
            ...
            {level2:"コミック/アニメグッズ",level2_children:["ストラップ","キーホルダー","バッジ","カード","クリアファイル","ポスター","タオル","その他"]},
           ...
           {level1:"家電・スマホ・カメラ",level1_children:[
            {level2:"スマートフォン/携帯電話",level2_children:["スマートフォン本体","バッテリー/充電器","PHS本体","その他"]},
           ...
           {level1:"ハンドメイド",level1_children:[
            ...
            {level2:"二次創作物",level2_children:["Ingress","クリエイターズ宇宙兄弟"]},
            {level2:"その他",level2_children:["その他"]}
                                              ]
           },
           ...
           {level1:"自動車・オートバイ",level1_children:[
            ...
            {level2:"オートバイ車体",level2_children:["オートバイ車体"]},
           ...
           {level1:"その他",level1_children:[
            {level2:"まとめ売り",level2_children:["まとめ売り"]},
